              ...
              <GlassCard className="relative overflow-hidden !p-0 border-t border-l border-white/20 border-b-4 border-b-ssfi-gold/50 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                ...
                <div className="bg-white/5 p-4 text-center border-t border-white/5">
                  <p className="text-xs text-white/30">
                    Protected by SSFI Digital • <a href="#" className="hover:text-white underline">Forgot Password?</a> • <a href="#/register" className="hover:text-ssfi-gold text-white/50 underline transition-colors">Register Here</a>
                  </p>
                </div>
              </GlassCard>
            </motion.div>
